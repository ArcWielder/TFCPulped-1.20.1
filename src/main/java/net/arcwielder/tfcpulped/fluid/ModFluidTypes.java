...
public class ModFluidTypes {
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () -> new BaseFluidType(WATER_STILL_RL, WATER_FLOWING_RL, WOOD_PULP_OVERLAY_RL,
                0xA1CF9565, new Vector3f( 207f / 255f, 149f / 255f, 101f / 255f), properties));
    }
