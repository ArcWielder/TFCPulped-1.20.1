package net.arcwielder.tfcpulped.block.entity.renderer;
...
public class DryingBasinBlockEntityRenderer implements BlockEntityRenderer<DryingBasinBlockEntity> {
    public DryingBasinBlockEntityRenderer(BlockEntityRendererProvider.Context context) {

    }

    @Override
    public void render(DryingBasinBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack,
